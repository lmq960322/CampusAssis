...
public class FreshAssistActivity<myOnClickListener> extends Activity{
	...
	protected void onCreate(Bundle savaInstanceState){
		...
		setContentView(R.id.freshAssist);
		int []btnIds=new int []{R.id.woshi,R.id.xuezhang,R.id.zhengli,R.id.dida,R.id.jiejiao,R.id.qinlian,R.id.shenghuo,R.id.ruxiao};
		Button[] btns=new Button[btnIds.length];//创建对应长度的按钮数组
